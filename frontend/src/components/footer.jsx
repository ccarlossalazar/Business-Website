...
const Footer = () => {
    return (
        <>
        <footer id="contact" className="text-center bg-green-800 text-white font-semibold p-4 text-sm">
    <h1 className="p-2">(650) 560-9370 | <a href="westcoastjanitorial.com">westcoastjanitorial.com</a></h1>
